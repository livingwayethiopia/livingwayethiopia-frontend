...
const PartnershipComponent = ({
  ...
  data: Maybe<ComponentSupportUsPartnerShip>;
}) => {
  return (
        ...
        {data?.partnership!.map((item, index) => {
          return (
            <div
              ...
              style={{ background: `${theme.colors.background}55 ` }}
              key={index}
            >
              <div
                className="py-3 z-10 text-xl absolute text-center "
                style={{
                  background: `${theme.colors.third}55`,
              ...
              <div className="px-3">
                ...
                <p className="mt-1 mb-3 text-md  font-light leading-4 ">
