  ...
  return (
    <SermonContainer>
      <div className="topPart">
        <div className="tabs">
          <TabContainer
            active={ActiveTabData.Videos === sermon}
            onClick={() => {
          ...
          >
            <p>
              {process.env.NEXT_PUBLIC_LANGUAGE === "en" ? "Videos" : "ቪዲዮዎች"}
            </p>
          </TabContainer>
          <TabContainer
            active={ActiveTabData.Podcasts === sermon}
            onClick={() => {
          ...
          >
            <p>
              {" "}
              {process.env.NEXT_PUBLIC_LANGUAGE === "en" ? "Podcast" : "ፖድካስቶች"}
            </p>
          </TabContainer>
        </div>
