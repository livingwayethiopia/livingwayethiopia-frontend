...
const WhoWeAre = ({ aboutUs }: { aboutUs: AboutUsEntity }) => {
  return (
    <Container>
      <div className="mt-10">
                ...
                <div
                  className={
                    data?.detail?.length! > 1
                      ? "grid gap-x-6 gap-y-1 justify-between row-gap-10 mx-auto lg:grid-cols-2"
                      : ""
                  }
                >
                  {data?.detail &&
                      ...
                      return (
                        <div className="flex w-full items-start " key={index}>
                          {data?.detail?.length! > 1 && (
                            <div className="mr-4">
                              <div
                                className="flex items-center justify-center w-8 h-8 mb-4 rounded-full bg-indigo-50"
                          ...
                          {item?.content! && (
                            <div className=" pr-10 sm:pr-2 text-lg">
