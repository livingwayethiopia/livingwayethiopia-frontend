        ...
        {data.playing && (
          <div
            ...
            style={{
              height: "100%",
              width: "100%",
              background: `${theme.colors.third}99`,
            }}
          >
            <svg
              width="41"
